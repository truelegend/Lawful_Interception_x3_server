...
li_server: li_server.o x3parser.o log.o udpx3cachequeue.o mediapcaploader.o
	g++ -o li_server li_server.o x3parser.o log.o udpx3cachequeue.o mediapcaploader.o -Wall -lpcap -lpthread -g
